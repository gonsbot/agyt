...
>   
    """
    WELCOME_MSG = "Hai {}\nAku bisa mendownload video dari youtube\n𝐒𝐞𝐚𝐫𝐜𝐡 𝐈𝐧𝐥𝐢𝐧𝐞- 𝐬𝐞𝐥𝐞𝐜𝐭 𝐚𝐧𝐝 𝐝𝐨𝐰𝐧𝐥𝐨𝐚𝐝."
    OPTIONS_TXT = "Aku bisa mendownload video dari Youtube.\n𝐒𝐞𝐚𝐫𝐜𝐡 𝐈𝐧𝐥𝐢𝐧𝐞- 𝐬𝐞𝐥𝐞𝐜𝐭 𝐚𝐧𝐝 𝐝𝐨𝐰𝐧𝐥𝐨𝐚𝐝."
    RESULTS_TXT = "Hasil :"
    NO_RESULTS = "Tidak ada hasil:"
    DESCRIPTION = "Durasi: {} || {}"
    NOT_AUTH_TXT = "Kamu tidak di izinkan"
    DEFAULT_TITLE = "𝐈𝐧𝐥𝐢𝐧𝐞 𝐓𝐮𝐛𝐞 𝐌𝐚𝐭𝐞 𝐑𝐞𝐩𝐨𝐬𝐢𝐭𝐨𝐫𝐲"
    DEFAULT_THUMB_URL = "https://image.flaticon.com/icons/png/512/25/25231.png"
    DEFAULT_LINK = "https://github.com/gonsbot"
    DEFAULT_DESCRIPTION = "Link @ezboyyxd"
    ...
    DEV_LINK = "https://t.me/ezboyyxd"
    DEV_DESCRIPTION = "Name : Ezboyy | Telegram"
    ...
    CHECKING_LINK = "Memeriksa URL"
    DOWNLOAD_START = "Sedang di Download"
    UPLOAD_START = "Di upload ke Telegra"
    NOT_DOWNLOADABLE = "URL tidak dapat di proses"
    CANCEL_PROCESS = "<b>Berhasil dibatalkan/b>"
...
URL | newfilename | username | password"""
    CUSTOM_CAPTION_UL_FILE = "\xad \xad\n<code>{}</code>\n\n<b>Made with ❤ by </b><b><a href='https://t.me/ezboyyxd'>Ezboyy</a></b>"
